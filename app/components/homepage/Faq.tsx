...
const FAQ = () => {
  ...
  return (
    <section className="pt-24 w-full max-w-7xl mx-auto">
      ...
      <div className="w-full px-4 sm:px-6 lg:px-8 mt-20">
        <div className="flex flex-col justify-center gap-y-5 lg:flex-row w-full">
          <div className="w-full lg:w-[40%] flex flex-col gap-3">
            <h1 className="lg:text-3xl md:text-2xl text-xl font-[system-ui] font-[700] text-start text-[#001F3F]">
              Have Questions About Buying Instagram Followers?
            </h1>
            <h1
              style={{
              ...
              className="lg:text-3xl md:text-2xl text-xl font-bold  inline-block "
            >
              The Buzzoid FAQ
            </h1>
          </div>
            ...
            <div className="flex flex-col gap-2 w-full">
              {FAQComponent.map((item, index) => (
                ...
                >
                  <button className="flex items-center justify-between text-left text-lg font-medium leading-8 w-full">
                    ...
                    <Image
                      ...
                      className={`transition-transform duration-300 ${
                        isOpen && item.id === faqID ? "rotate-45" : ""
                      }`}
                  ...
                  >
                    {item.id === faqID ? (
                      <p className="text-base text-[#001F3F] font-medium leading-6 font-[system-ui]">
                        {item.content}
                      </p>
                    ) : null}
                  </div>
